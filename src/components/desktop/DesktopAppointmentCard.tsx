...
export interface DesktopAppointmentCardProps {
...
export function DesktopAppointmentCard({
  appointment,
  index,
  onAction,
  notas = [],
  ...
  return (
    <article
      id={`desktop-card-${appointment.id}`}
      className={cn(
    ...
    >
      ...
      <div className="flex flex-row">
        {/* Trilho de Horário e Status Desktop */}
        <div
          className={cn(
            "flex w-28 shrink-0 flex-col items-center justify-center border-r py-5",
            concluido ? "border-ok/25 bg-ok/5" : "border-line bg-paper/40 gap-1.5",
          )}
        >
          {concluido ? (
            <div
        ...
        <div className="flex-1 p-5">
          {/* Topo: Procedimentos, Etiquetas e Ações de Cabeçalho */}
